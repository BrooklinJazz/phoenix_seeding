defmodule SeedWeb.AuthorAuthTest do
  use SeedWeb.ConnCase, async: true

  alias Seed.Accounts
  alias SeedWeb.AuthorAuth
  import Seed.AccountsFixtures

  @remember_me_cookie "_seed_web_author_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SeedWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_author/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SeedWeb.Endpoint.subscribe(live_socket_id)
