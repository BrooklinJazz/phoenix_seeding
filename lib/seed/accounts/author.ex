defmodule Seed.Accounts.Author do
  use Ecto.Schema
  import Ecto.Changeset
  alias Seed.Posts.Post
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Seed.Repo)
  ...
  """
  def valid_password?(%Seed.Accounts.Author{hashed_password: hashed_password}, password)
